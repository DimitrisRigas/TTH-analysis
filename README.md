...
8/1/2025 Though of a solution in my efforts to save the dileptonic case. Instead of doing boosted and getting 2 double b tagged jets im going do do a semi try where i have atleast 1 double b jet and atleast 3 bjets. Need to think of a way to select the correct b jet though for the reconstruction of Higgs variables because i have the same problem i had with mass 60
